...
import com.freedu.mypdfbooks.databinding.FragmentImportantBooksBinding
...
class ImportantBooksFragment : Fragment() {
    private lateinit var binding: FragmentImportantBooksBinding
    private lateinit var viewModel: BookViewModel
    private lateinit var impadapter: BookAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentImportantBooksBinding.inflate(inflater, container, false)
        ...
        titleTextView.text = "Important Books"

        val activity = requireActivity() as AppCompatActivity
        activity.supportActionBar?.setDisplayShowTitleEnabled(false)
        activity.supportActionBar?.setDisplayHomeAsUpEnabled(false)

        impadapter = BookAdapter(
            onClick = {
        ...
        binding.recyclerView.adapter = impadapter


        viewModel = ViewModelProvider(this).get(BookViewModel::class.java)
        viewModel.importantBooks.observe(viewLifecycleOwner) { books -> impadapter.submitList(books.toList()) }
